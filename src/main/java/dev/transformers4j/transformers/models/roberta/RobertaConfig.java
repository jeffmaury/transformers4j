...
/**
 * This is the configuration class to store the configuration of a [`RobertaModel`] or a [`TFRobertaModel`]. It is used
 * to instantiate a RoBERTa model according to the specified arguments, defining the model architecture. Instantiating a
 ...
 *
 *
 * Args: vocab_size (`int`, *optional*, defaults to 50265): Vocabulary size of the RoBERTa model. Defines the number of
 * different tokens that can be represented by the `inputs_ids` passed when calling [`RobertaModel`] or
 * [`TFRobertaModel`]. hidden_size (`int`, *optional*, defaults to 768): Dimensionality of the encoder layers and the
 * pooler layer. num_hidden_layers (`int`, *optional*, defaults to 12): Number of hidden layers in the Transformer
 * encoder. num_attention_heads (`int`, *optional*, defaults to 12): Number of attention heads for each attention layer
 * in the Transformer encoder. intermediate_size (`int`, *optional*, defaults to 3072): Dimensionality of the
 * "intermediate" (often named feed-forward) layer in the Transformer encoder. hidden_act (`str` or `Callable`,
 * *optional*, defaults to `"gelu"`): The non-linear activation function (function or string) in the encoder and pooler.
 * If string, `"gelu"`, `"relu"`, `"silu"` and `"gelu_new"` are supported. hidden_dropout_prob (`float`, *optional*,
 * defaults to 0.1): The dropout probability for all fully connected layers in the embeddings, encoder, and pooler.
 ...
 * [`RobertaModel`] or [`TFRobertaModel`]. initializer_range (`float`, *optional*, defaults to 0.02): The standard
 * deviation of the truncated_normal_initializer for initializing all weight matrices. layer_norm_eps (`float`,
 * *optional*, defaults to 1e-12): The epsilon used by the layer normalization layers. position_embedding_type (`str`,
 * *optional*, defaults to `"absolute"`): Type of position embedding. Choose one of `"absolute"`, `"relative_key"`,
 ...
 * Examples:
 *
 * ```python >>> from transformers import RobertaConfig, RobertaModel
 *
 * >>> # Initializing a RoBERTa configuration >>> configuration = RobertaConfig()
 *
 * >>> # Initializing a model (with random weights) from the configuration >>> model = RobertaModel(configuration)
 *
 * >>> # Accessing the model configuration >>> configuration = model.config ```
 */
public class RobertaConfig extends PretrainedConfig {
    ...
    protected RobertaConfig(Map<String, Object> kwargs) throws RuntimeException {
        super(kwargs);
        this.model_type = "roberta";

        this.vocab_size = MapUtil.get(kwargs, "vocab_size", Integer.class, 50265);
